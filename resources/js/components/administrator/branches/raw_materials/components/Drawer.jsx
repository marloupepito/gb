                ...
                <form onSubmit={submitEvent}>
                    <DrawerContent>
                        ...
                        <DrawerFooter>
                            ...
                            <Button variant="outline" className="  bg-brand-500    text-base font-medium text-white transition duration-200 hover:bg-brand-600 active:bg-brand-700 dark:bg-brand-400 dark:text-white dark:hover:bg-brand-300 dark:active:bg-brand-200"  type="submit" colorscheme="blue">Save</Button>
                        </DrawerFooter>
                    </DrawerContent>
                </form>
            </Drawer>
