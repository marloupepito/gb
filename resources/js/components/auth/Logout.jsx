      ...
      <ModalBody className="p-0">
        <Card extra="px-[30px] pt-[35px] pb-[40px] max-w-[450px] flex flex-col !z-[1004]">
          ...
          <div className=" float-right">
            <button
            onClick={handleOk}
              className="float-right linear   border-2 border-red-500 px-3 py-2.5 text-base font-medium text-red-500 transition duration-200 hover:bg-red-600/5 active:bg-red-700/5 dark:border-red-400 dark:bg-red-400/10 dark:text-white dark:hover:bg-red-300/10 dark:active:bg-red-200/10"
            >
              Logout
            </button>
          </div>
