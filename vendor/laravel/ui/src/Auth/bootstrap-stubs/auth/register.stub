                ...
                <div className="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div className="row mb-3">
                            <label for="name" className="col-md-4 col-form-label text-md-end">{{ __('Name') }}</label>
                        ...
                        <div className="row mb-3">
                            <label for="password-confirm" className="col-md-4 col-form-label text-md-end">{{ __('Confirm Password') }}</label>
