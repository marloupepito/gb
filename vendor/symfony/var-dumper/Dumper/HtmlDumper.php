    ...
    try {
        ...
        for (i = 0; i < len; ++i) {
            ...
            if (0 < x) {
                ...
                elt.innerHTML = '<span class=sf-dump-str-collapse>'+h+'<a className="sf-dump-ref sf-dump-str-toggle" title="Collapse"> ◀</a></span>'+
                    '<span class=sf-dump-str-expand>'+elt.innerHTML+'<a className="sf-dump-ref sf-dump-str-toggle" title="'+x+' remaining characters"> ▶</a></span>';
            }
        }
    } catch (e) {
    }
